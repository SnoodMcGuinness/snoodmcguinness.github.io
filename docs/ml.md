...
Since scaling compute has been so effective, and transformers have become the dominant architecture, research has naturally shifted to analysing these huge LLMs; studying the surprising seemingly emergent abilities they possess, how to prompt in interesting ways to get the best responses, and of course trying to understand how they actually work and what they're actually doing to prevent mass extinction of the human race.
